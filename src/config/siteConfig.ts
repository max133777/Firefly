...
export const siteConfig: SiteConfig = {
	...
	// 站点描述
	description:
		"欢迎来到萃英电子联盟的官方博客网站!在这里你可以找到电子技术分享、各类软硬件开源资料、教程文档、电子类竞赛真题和经验、项目实践,涵盖PCB设计、单片机开发、嵌入式系统设计、具身智能、AI等前沿方向。萃英电子联盟致力于打造优质的电子技术学习社区!",
	...
	navbar: {
		...
		logo: {
			type: "image",
			value: "assets/images/logo/cyea.png",
			valueDark: "assets/images/logo/cyea.png",
			alt: "🍀",
		},
		// 导航栏标题
		title: "萃英电子联盟",
