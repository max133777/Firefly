...
export const site = {
  name: "萃英电子联盟",
  desc: "面向电子技术爱好者的学习与实践社区",
  url: "https://cuiyingdianzi.com",
  avatar: "/favicon/cyea.png",
};
      ...
      <div class="p-5 sm:p-6 flex flex-col flex-1">
        ...
        <div class="space-y-0 flex-1">
          ...
          <div class="flex gap-3.5">
            ...
            <div class="pb-4">
              <p class="font-semibold text-sm mb-1">在留言板 / 评论区提交申请</p>
              <p class="text-xs text-neutral-500 dark:text-neutral-400 leading-relaxed">申请模板，把内容复制修改后发送给我们</p>
